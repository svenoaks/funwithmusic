...
/**
 * A {@link SilkAdapter} that displays {@link Card} and {@link CardHeader}
 * objects in a {@link CardListView}.
 * 
...
public class CardAdapter<ItemType extends CardBase<ItemType>> extends SilkAdapter<ItemType>
{
	 ...
	 * 
	 * @param context
	 *            The context used to inflate layouts and retrieve resources.
	 */
	 ...
	 *            The context used to inflate layouts and retrieve resources.
	 * @param cardLayoutRes
	 *            Sets a custom layout to be used for all cards (not including
	 *            headers) in the adapter. This <b>does not</b> override layouts
	 *            set to individual cards.
	 */
	 ...
	 *            headers) in the adapter. This <b>does not</b> override layouts
	 *            set to individual cards.
	 * @param cardLayoutNoContentRes
	 *            Sets a custom layout to be used for all cards (not including
	 *            headers) in the adapter with null content. This <b>does
	...
	/**
	 * Sets the accent color used on card titles and header action buttons. You
	 * <b>should</b> call this method before adding any cards to the adapter to
	 * avoid issues.
	 * 
	 * @param color
	 ...
	 * buttons. You <b>should</b> call this method before adding any cards to
	 * the adapter to avoid issues.
	 * 
	 * @param colorRes
	...
	/**
	 * Sets a popup menu used for every card in the adapter, this will not
	 * override individual card popup menus. You <b>should</b> call this method
	 * before adding any cards to the adapter to avoid issues.
	 * 
	 * @param menuRes
	...
	/**
	 * Sets whether or not cards in the adapter are clickable, setting it to
	 * false will turn card's list selectors off and the list's
	 * OnItemClickListener will not be called. This <b>will</b> override
	 * individual isClickable values set to {@link Card}s.
	 */
	...
	public int getLayout(int index, int type)
	{
		...
		if (layout <= 0)
		{
			// If no layout was specified for the individual card, use the
			// adapter's set layout
			layout = mLayout;
		}
		return layout;
	}
			...
			public void onClick(View v)
			{
				...
				popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener()
				{
					...
					public boolean onMenuItemClick(MenuItem item)
					{
						...
						{
							// The card does not have a unique menu, use the
							// adapter's default
	...
	public View onViewCreated(int index, View recycled, ItemType item, ViewGroup parent, SilkAdapter.ViewHolder viewHolder)
	{
		...
		if (viewHolder.icon != null)
		{
			if (onProcessThumbnail(viewHolder.icon, item, parent))
			{
	...
	{
		// There's 3 layout types by default: cards, cards with no content, and
		// card headers.
		int viewTypes = 3;
